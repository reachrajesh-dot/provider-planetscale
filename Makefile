# ====================================================================================
# Setup Project
PROJECT_NAME := provider-planetscale
...
XPKGS = provider-planetscale
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-planetscale: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider PlanetScale CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider PlanetScale controllers
...
# This target prepares repo for your provider by replacing all "planetscale"
